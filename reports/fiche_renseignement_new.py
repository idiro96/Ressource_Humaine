...
class FicheRenseignementNew(models.Model):
    _inherit = 'hr.employee'

    @api.multi
    def print_fiche(self):
        return self.env.ref('ressource_humaine.action_fiche_renseignement_new_report').report_action(self)


class FicheRenseignementNewReport(models.AbstractModel):
    _name = 'report.ressource_humaine.fiche_renseignement_new_report'
