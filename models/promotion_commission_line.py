...
class RHPromotionCommissionLine(models.Model):
    ...
    #     new_record = super(RHPromotionCommissionLine, self).create(vals)
    #
    ...
    #
    #     return super(RHPromotionCommissionLine, self).unlink()
    #
    # def write(self, vals):
    ...
    #
    #     result = super(RHPromotionCommissionLine, self).write(vals)
    #
